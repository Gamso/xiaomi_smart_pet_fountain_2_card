          ...
          <div class="gauge-container">
            ...
            <div class="status-icons-row">
              ...
              <div class="icon-indicator">
                <ha-icon
                  icon="${function(t,e){if(!t)return"mdi:battery";const i=t.toLowerCase();return i.includes("no charge")&&0===e?"mdi:battery-alert":i.includes("charging")&&!i.includes("full")?"mdi:battery-charging":i.includes("full")?"mdi:power-plug":e>=90?"mdi:battery":e>=70?"mdi:battery-80":e>=50?"mdi:battery-60":e>=30?"mdi:battery-40":e>=10?"mdi:battery-20":"mdi:battery-alert"}(f,d)}"
                  class="${function(t,e){return t?t.toLowerCase().includes("no charge")&&0===e?"critical-icon-pulse":t.toLowerCase().includes("charging")?"charging":"":""}(f,d)}"
